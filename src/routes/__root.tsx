...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "The Ninth House Immigration Solutions Inc." },
      { property: "og:description", content: "Guiding your journey with clarity, courage, and compassion." },

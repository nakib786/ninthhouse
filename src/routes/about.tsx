...
const credentials = [
  { Icon: Award, title: "CICC Licensed", body: "College of Immigration and Citizenship Consultants" },
  { Icon: BookOpen, title: "CAPIC Member", body: "Canadian Association of Professional Immigration Consultants" },
  { Icon: ShieldCheck, title: "RCIC-IRB Class L3", body: "Authorized before all IRB divisions" },
  { Icon: FileCheck, title: "Commissioner for Affidavits", body: "Authorized in British Columbia" },
];
    ...
    <>
      ...
      <section className="bg-bg py-24 md:py-32">
        <div className="max-w-[1440px] mx-auto px-6 md:px-10 grid lg:grid-cols-[1.2fr_1fr] gap-16 items-start">
          <Reveal>
            <div className="font-mono text-[11px] tracking-widest text-red uppercase mb-5">Our Story</div>
          ...
          <div className="mt-14 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {credentials.map(({ Icon, title, body }, i) => (
              <Reveal key={title} delay={i * 0.05}>
                <div className="bg-white border-t-2 border-red p-8 text-center h-full">
                  <Icon className="w-9 h-9 text-red mx-auto mb-5" aria-hidden="true" />
                  <div className="font-mono text-[12px] tracking-widest text-red uppercase">{title}</div>
            ...
            {values.map((v, i) => (
              <Reveal key={v.n} delay={i * 0.06}>
                <div className="relative pt-12">
                  <div className="absolute top-0 left-0 font-display font-semibold text-red/15 leading-none" style={{ fontSize: 110 }}>{v.n}</div>
      ...
      <section className="bg-navy text-white py-24 md:py-28">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <Reveal>
            <Gavel className="w-12 h-12 mx-auto text-white mb-6" aria-hidden="true" />
